...
#BLAS.lbt_forward(joinpath("/scratch/pc2-mitarbeiter/bauerc/playground/OpenBLAS-0.3.20", "libopenblas.so"); clear=true)
BLAS.lbt_forward(joinpath("/scratch/pc2-mitarbeiter/bauerc/playground/OpenBLAS-0.3.17", "libopenblas.so"); clear=true)
@show BLAS.get_num_threads()
